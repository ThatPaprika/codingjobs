...
/*
	...
	- Step 2: 'new-movie.html' should contain a form to insert a new movie.
		You should create all the necessary inputs (title, views....).

		For now, the director id should be an input:number.
		
	- Step 3 :
		When clicking on submit button you must do an AJAX call to the 'insert-movie.php' file.
